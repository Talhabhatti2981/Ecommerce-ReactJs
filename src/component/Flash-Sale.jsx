              ...
              <SwiperSlide key={index}>
                <div className="group">
                  <div className="relative overflow-hidden">
                    <Link to="Wishlist">
                      {" "}
                      <MdFavoriteBorder className="absolute top-5 left-[243px] w-7 h-7 bg-white rounded-full p-1 shadow" />{" "}
                    </Link>
                    <Link to="/Products">
                    <IoEyeOutline className="absolute top-16 left-[243px] w-7 h-7 bg-white rounded-full p-1 shadow" />
                    </Link>
                    <img
                      src={product.img}
                      alt="product"
